...
{
    private static async Task SeedDataAsync(ISqlConnectionFactory sqlConnectionFactory)
    {
        using var connection = await sqlConnectionFactory.CreateOpenConnectionAsync();
        var faker = new Faker();
